...
### How to run
>**run helm-zabbix-server and helm-zabbix-web separately, then forward the port 80 to 8080 ( kubectl port-forward my-release-web-0 8080:80 ) and then access the web interface in your browser at localhost:8080, username/password are Admin/zabbix**
